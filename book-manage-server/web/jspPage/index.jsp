...
<head>
    ...
    <link href="<%=basePath%>static/css/bootstrap.min.css?v=3.3.6" rel="stylesheet">
    <link href="<%=basePath%>static/css/font-awesome.min.css?v=4.4.0" rel="stylesheet">
    <link href="<%=basePath%>static/css/plugins/toastr/toastr.min.css" rel="stylesheet">
...
<!-- 自定义js -->
<script src="<%=basePath%>static/js/app.js?v=4.1.0"></script>
...
<script type="text/javascript"
        src="<%=basePath%>static/js/vue.min.js">

</script>
<script src="<%=basePath%>static/js/appjs/oa/webSocket/sockjs.min.js"></script>
<script src="<%=basePath%>static/js/appjs/oa/webSocket/stomp.min.js"></script>
<!-- Toastr script -->
